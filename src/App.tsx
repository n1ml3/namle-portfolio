  ...
  const projects = [
    {
      ...
      description: "Một nền tảng thương mại điện tử đầy đủ tính năng được xây dựng với React và Node.js",
    ...
    },
    {
      ...
      description: "Ứng dụng quản lý công việc với tính năng kéo thả và cộng tác nhóm",
      image: "/placeholder.svg?height=200&width=300",
